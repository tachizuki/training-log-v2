...
プレミアムプラン（月額400円）では全期間の履歴閲覧・大会ロードマップ・週レポート・筋トレ分析・複数端末クラウド同期が利用できます。

🎁 初回登録は 14日間 無料。期間内に解約すれば料金は発生しません。
...
Premium ($2.99/month) unlocks unlimited history, contest roadmap, weekly reports, training analytics, and multi-device cloud sync.

🎁 14-day free trial for first-time subscribers. Cancel anytime before the trial ends and you won't be charged.
